function rois = get_all_rois()
% 
% List of names of all possible rois, for filtering out unneeded units

rois = {'LGd-sh', 'LGd-co', 'LGd-ip', 'LGd', 'LGv', 'LP', 'PO', 'POL', 'APN', ...
        'SCs', 'SCsg', 'SCsg', ...
        'SCdg', 'SCdw', 'SCiw', 'SCig', ...
        'SNr', ...
        'VISp1','VISp2/3','VISp4','VISp5','VISp6a', 'VISp6b', ...
        'PF', 'PO', 'POL', 'PVT', 'TH', 'VPM', 'SPFm', 'SPFp', 'SPA', 'Eth', 'CL', 'LH', ...
        ...
        'CP',  'STR', 'STR-unassigned', 'FS', 'OT', 'LSc', 'LSr', 'LSv', 'SF', 'SH', ...

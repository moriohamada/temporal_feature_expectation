function quantify_baseline_gain_changes_by_cont(avg_resps, t_ax, indexes, ops)
...
for cont_i = 1:2
    ...
    for r = [1 3]%1:height(rois)
        flip_tf = flip_tfs(r);
        in_area = utils.get_units_in_area(indexes.loc, rois{r,2}) & indexes.conts==cont;
    ...
    sgtitle(sprintf('contingency: %d', cont));
end
if ops.saveFigs

function [dm,trialID] = compileSparseDesignMatrixWithTrialInd(dspec, trialIndices)
% Compile information from experiment according to given DesignSpec
% Modified from compileSparseDesignMatrix - also outputs the trial number that each row of design
% matrix belongs to.
...
%         end
    ...
    trialID  = [trialID; kTrial*ones(size(miniX,1),1)];
end
